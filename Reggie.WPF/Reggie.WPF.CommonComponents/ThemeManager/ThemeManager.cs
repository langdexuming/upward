        ...
        public static IEnumerable<Accent> Accents
        {
            get
            {
                ...
                try
                {
                    ...
                    {
                        var resourceAddress = new Uri($"pack://application:,,,/Reggie.WPF.CommonComponents;component/Styles/Accents/{color}.xaml");
                        _accents.Add(new Accent(color, resourceAddress));
                    }
                }
                catch (Exception e)
                {
                    throw new CommonComponentsException("This exception happens because you are maybe running that code out of the scope of a WPF application. Most likely because you are testing your configuration inside a unit test.", e);
                }
